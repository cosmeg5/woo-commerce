...
//Função para mudar as configurações do tamanho da imagem
function handel_custom_images() {
    add_image_size('slide', 1000, 800, ['center', 'top']);//configura um novo tamanho de imagem
    update_option('medium_crop', 1); //configura tamanho da imagem definido pelo usuario
}
add_action('after_setup_theme', 'handel_custom_images');

//Mudar quantidade de produtos a amostra na loja
